...
- **测试日期**：2026-09-20 16:12 UTC　·　**任务**：V11-11（KNOWN-ISSUES #8 回填）· 作者：程基岩
...
|---|---|---|---|---|---|---|---|---|---|
| A · L1 空场（开局无实体） | 0.11 | 0.25 | 0.60 | 0.14 | 1% | 448 | 304 | 155 | +96.1% |
| B · L1 中期（6 植物 + 10 僵尸） | 0.26 | 0.56 | 4.80 | 0.34 | 3% | 1034 | 702 | 605 | +16.0% |
| C · L3 末波（12 植物 + 25 僵尸含 bucket） | 0.44 | 0.94 | 1.21 | 0.53 | 6% | 1747 | 1203 | 1009 | +19.2% |
| D · L4 末波地狱（15 植物 + 30 僵尸含双桶，水景） | 0.53 | 1.10 | 2.35 | 0.64 | 7% | 2047 | 1359 | — | —（新场景无估算） |
| E · L5 末波地狱（15 植物 + 30 僵尸含双桶，屋顶） | 0.89 | 1.88 | 15.21 | 1.10 | 11% | 2778 | 1460 | — | —（新场景无估算） |
