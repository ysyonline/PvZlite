...
- **测试日期**：2026-09-24 12:32 UTC　·　**任务**：V11-11（KNOWN-ISSUES #8 回填）· 作者：程基岩
- **环境**：Node v22.22.2 · win32 x64 · Intel(R) Core(TM) i5-7500T CPU @ 2.70GHz × 4
...
|---|---|---|---|---|---|---|---|---|---|
| A · L1 空场（开局无实体） | 0.12 | 0.29 | 3.64 | 0.15 | 2% | 290 | 194 | 155 | +25.2% |
| B · L1 中期（6 植物 + 10 僵尸） | 0.32 | 0.70 | 4.55 | 0.41 | 4% | 876 | 592 | 605 | -2.1% |
| C · L3 末波（12 植物 + 25 僵尸含 bucket） | 0.56 | 1.44 | 4.69 | 0.70 | 9% | 1590 | 1092 | 1009 | +8.2% |
| D · L4 末波地狱（15 植物 + 30 僵尸含双桶，水景） | 0.66 | 2.01 | 8.10 | 0.86 | 12% | 1890 | 1250 | — | —（新场景无估算） |
| E · L5 末波地狱（15 植物 + 30 僵尸含双桶，屋顶） | 1.05 | 2.74 | 6.32 | 1.33 | 16% | 2665 | 1381 | — | —（新场景无估算） |
