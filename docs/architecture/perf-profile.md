...
- **测试日期**：2026-09-20 15:56 UTC　·　**任务**：V11-11（KNOWN-ISSUES #8 回填）· 作者：程基岩
...
|---|---|---|---|---|---|---|---|---|---|
| A · L1 空场（开局无实体） | 0.11 | 0.24 | 0.59 | 0.14 | 1% | 448 | 304 | 155 | +96.1% |
| B · L1 中期（6 植物 + 10 僵尸） | 0.27 | 0.63 | 1.58 | 0.34 | 4% | 1034 | 702 | 605 | +16.0% |
| C · L3 末波（12 植物 + 25 僵尸含 bucket） | 0.46 | 0.99 | 3.75 | 0.57 | 6% | 1747 | 1203 | 1009 | +19.2% |
| D · L4 末波地狱（15 植物 + 30 僵尸含双桶，水景） | 0.52 | 1.12 | 5.17 | 0.64 | 7% | 2047 | 1359 | — | —（新场景无估算） |
| E · L5 末波地狱（15 植物 + 30 僵尸含双桶，屋顶） | 0.82 | 1.59 | 2.30 | 0.97 | 10% | 2778 | 1460 | — | —（新场景无估算） |
