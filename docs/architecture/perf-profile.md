...
- **测试日期**：2026-09-24 13:54 UTC　·　**任务**：V11-11（KNOWN-ISSUES #8 回填）· 作者：程基岩
- **环境**：Node v22.22.2 · win32 x64 · Intel(R) Core(TM) i5-7500T CPU @ 2.70GHz × 4
...
|---|---|---|---|---|---|---|---|---|---|
| A · L1 空场（开局无实体） | 0.11 | 0.14 | 0.44 | 0.12 | 1% | 290 | 194 | 155 | +25.2% |
| B · L1 中期（6 植物 + 10 僵尸） | 0.31 | 0.46 | 1.02 | 0.33 | 3% | 876 | 592 | 605 | -2.1% |
| C · L3 末波（12 植物 + 25 僵尸含 bucket） | 0.54 | 0.78 | 2.62 | 0.57 | 5% | 1590 | 1092 | 1009 | +8.2% |
| D · L4 末波地狱（15 植物 + 30 僵尸含双桶，水景） | 0.63 | 0.87 | 1.36 | 0.66 | 5% | 1890 | 1250 | — | —（新场景无估算） |
| E · L5 末波地狱（15 植物 + 30 僵尸含双桶，屋顶） | 1.01 | 1.26 | 1.65 | 1.05 | 8% | 2665 | 1381 | — | —（新场景无估算） |
