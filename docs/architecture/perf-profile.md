...
- **测试日期**：2026-09-20 12:53 UTC　·　**任务**：V11-11（KNOWN-ISSUES #8 回填）· 作者：程基岩
...
|---|---|---|---|---|---|---|---|---|---|
| A · L1 空场（开局无实体） | 0.28 | 0.58 | 2.33 | 0.36 | 3% | 448 | 304 | 155 | +96.1% |
| B · L1 中期（6 植物 + 10 僵尸） | 0.65 | 1.30 | 2.45 | 0.80 | 8% | 1034 | 702 | 605 | +16.0% |
| C · L3 末波（12 植物 + 25 僵尸含 bucket） | 1.12 | 2.28 | 7.77 | 1.37 | 14% | 1747 | 1203 | 1009 | +19.2% |
| D · L4 末波地狱（15 植物 + 30 僵尸含双桶，水景） | 1.32 | 2.69 | 7.38 | 1.62 | 16% | 2047 | 1359 | — | —（新场景无估算） |
| E · L5 末波地狱（15 植物 + 30 僵尸含双桶，屋顶） | 2.03 | 3.90 | 8.21 | 2.45 | 23% | 2782 | 1461 | — | —（新场景无估算） |
