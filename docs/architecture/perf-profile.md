...
- **测试日期**：2026-09-20 15:06 UTC　·　**任务**：V11-11（KNOWN-ISSUES #8 回填）· 作者：程基岩
...
|---|---|---|---|---|---|---|---|---|---|
| A · L1 空场（开局无实体） | 0.21 | 0.42 | 1.55 | 0.20 | 3% | 448 | 304 | 155 | +96.1% |
| B · L1 中期（6 植物 + 10 僵尸） | 0.34 | 0.71 | 6.00 | 0.42 | 4% | 1034 | 702 | 605 | +16.0% |
| C · L3 末波（12 植物 + 25 僵尸含 bucket） | 0.64 | 1.35 | 5.70 | 0.75 | 8% | 1747 | 1203 | 1009 | +19.2% |
| D · L4 末波地狱（15 植物 + 30 僵尸含双桶，水景） | 0.96 | 3.43 | 59.12 | 1.54 | 21% | 2047 | 1359 | — | —（新场景无估算） |
| E · L5 末波地狱（15 植物 + 30 僵尸含双桶，屋顶） | 1.45 | 3.25 | 13.48 | 1.63 | 20% | 2778 | 1460 | — | —（新场景无估算） |
