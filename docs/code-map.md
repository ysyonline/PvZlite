...
> 源文件：`plants-vs-zombies.html`（4349 行 · 103 个顶层函数 · 77 个顶层常量 · 20 个分区）
...
| D-11 圆角化（蓝图 §6） | L3694–L4346 | 653 | 11 |
...
| 函数 | `drawEnd` | L4154–L4346 | （T-10 实装见 DECK_GRID 区，L1023 起） |
