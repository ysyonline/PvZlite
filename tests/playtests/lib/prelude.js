 ...
 * 环境变量：PVZ_HTML_PATH 覆盖被测源码；PVZ_EXPECT_VER 覆盖期望版本（缺省 v1.9.0）
 *
...
const EXPECT = {
  // 源码实际常量带 v 前缀（L52 `VERSION='v1.9.0'`）；比较时两侧归一化剥前缀，env 可给任意写法
  get VERSION() { return process.env.PVZ_EXPECT_VER || 'v1.9.0'; },
