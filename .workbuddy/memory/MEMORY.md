...
- **M4 进行中（09-24 公司机）：T-401 昼夜色板查表化 ✅（`367e55b`）：drawGameWorld 色板切 time 查 WORLD_THEMES（_isNight=night||fog 统一驱动）+dusk 滤镜退役（Q-11，-12 行）；v20-daynight-ui 6/6（g 通道差分判据，旧源 ⑤⑥ 双红）；SMOKE 29/29；源码 3515 行。09-24 13:0x 积压 8 刀已推 origin（`d863808..367e55b`，ls-remote 双确认），main 与远端同步。下一单元 T-402 浓雾遮罩层——验收必须走 `?level=2-6` URL 直跳，禁止点击选关页链路（Q-12 世界 2 全占位格）**
- 遗留：R5 弹道手感人工复核
