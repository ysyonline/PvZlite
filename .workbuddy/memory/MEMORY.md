...
## ★ 新会话接手入口（开场必做，别重新摸索）
1. 读**日期最新**的那份 `.workbuddy/memory/YYYY-MM-DD.md` 末尾的「📌 新会话接手指南」（当前是 **`2026-09-18.md` 12:39 归档版**，文件内更早节仅作历史参考，**以末尾那份为准**）
2. **当前状态 = v1.2 V12-03 + V12-03b 真机反馈修复完成、四道门控全绿（烟雾 26/26 · 回归 --all 56/56 · 总线 56/56 · bench PASS），工作树 12 文件未提交**——开场先确认 M3b/M3c 真机复验结果 + 是否提交推送（12 个文件清单与两刀提交建议都在指南里）
